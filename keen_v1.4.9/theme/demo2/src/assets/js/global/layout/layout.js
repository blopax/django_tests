        ...
        if (KTUtil.attr(menu, 'data-ktmenu-scroll') === '1') {
            scroll = {
                ...
                height: function() {  // calculate available scrollable area height
                    var height;
                    var page = KTUtil.getByClass('kt-page');

                    height = parseInt(KTUtil.getViewPort().height);

                    if (KTUtil.isInResponsiveRange('desktop')) {
                        height = height - parseInt(KTUtil.actualHeight('kt_aside_brand'));
                        height = height - (parseInt(KTUtil.css(page, 'paddingBottom')) + parseInt(KTUtil.css(page, 'paddingTop')));
                    }
